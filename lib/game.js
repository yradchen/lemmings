...
class Game {
  constructor() {
    ...
    // this.levelSelectionScreen = document.getElementById("select-options");
  }
    ...
    removeLevelSelectionScreen() {
      const levelSelectionScreen = document.getElementById("select-options");
...
// Congratulations on beating level X. Pick another level!
// Oops, you lost. Pick another level!
